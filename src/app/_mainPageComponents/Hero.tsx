        ...
        >
            <div className="h-screen w-full sticky top-0 overflow-hidden">
                <div className="h-full flex flex-col justify-center md:flex-row md:items-center md:gap-4 opacity-0 heroContainer">
                    <h1 className="text-[22vw] leading-[22.3vw] origin-left font-rowdies text-darkBlue  heroText">
                        Scroll
                    </h1>
                    <div>
                        <p className="font-rowdies lg:leading-[64px]  text-[30px] lg:text-[60px] opacity-0 heroTextSmall ">
                            Forging
                        </p>

                        <p className="font-rowdies lg:leading-[64px]  text-[30px] lg:text-[60px] heroTextSmall">
                            Digital
                        </p>
                        <p className="font-rowdies lg:leading-[64px] text-[30px] lg:text-[60px] heroTextSmall">
                            Something...
